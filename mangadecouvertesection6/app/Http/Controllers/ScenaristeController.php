...
class ScenaristeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('index',compact('scenaristes'));
    }
    ...
    {
        return view('scenariste',compact('scenariste'));
    }
    ...
    {
        $scenariste->delete();
        return back()->with('info','Le scénariste a bien été supprimé de la base de données');
    }
}
